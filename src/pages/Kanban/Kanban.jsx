  ...
  return (
    <KanbanProvider>
      <DndProvider backend={backend}>
        ...
        <div className="flex h-screen bg-[#1d142e] text-white overflow-hidden">
          {/* <Sidebar /> */}
          <div className="flex-1 flex flex-col overflow-hidden">
            <main className="flex-1 pl-4 pt-6 sm:pl-6 md:pl-8 lg:pl-12 xl:px-16 xl:pr-5 pb-6  overflow-auto scrollbar-thin scrollbar-thumb-[#2D1B4F] scrollbar-track-transparent">
              <CategoryPanel />
            </main>
          </div>
        </div>
